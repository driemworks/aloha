...
function nsReplaceBootstrap(getNgCompiler) {
    ...
    const standardTransform = function (sourceFile) {
        ...
        entryModuleIdentifiers.forEach(entryModuleIdentifier => {
            ...
            const platformNativeScriptDynamicIdentifier = innerCallExpr.expression;
            ...
            new transformers_1.ReplaceNodeOperation(sourceFile, entryModuleIdentifier, ts.createPropertyAccess(idNgFactory, ts.createIdentifier(factoryClassName))), 
            // Replace 'platformNativeScriptDynamic' with 'platformNativeScript'
            // and elide all imports of 'platformNativeScriptDynamic'
            new transformers_1.ReplaceNodeOperation(sourceFile, platformNativeScriptDynamicIdentifier, ts.createPropertyAccess(idPlatformNativeScript, 'platformNativeScript')), 
            // Replace the invocation of 'boostrapModule' with 'bootsrapModuleFactory'
            new transformers_1.ReplaceNodeOperation(sourceFile, bootstrapModuleIdentifier, ts.createIdentifier('bootstrapModuleFactory')));
        });
        return ops;
    };
