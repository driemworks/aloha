...
describe('Add {N} schematic', () => {
    ...
    describe('when using the default options', () => {
        ...
        it('should add dependency to NativeScript schematics', () => {
            ...
            const configFileContent = JSON.parse(test_1.getFileContent(appTree, configFile));
        ...
        it('should add all required dependencies to the package.json', () => {
            ...
            const packageJson = JSON.parse(test_1.getFileContent(appTree, packageJsonPath));
        ...
        it('should exclude {N} files from the web TS compilation', () => {
            ...
            const webTsconfig = JSON.parse(test_1.getFileContent(appTree, webTsconfigPath));
        ...
        it('should generate a sample shared component', () => {
            ...
            expect(appRoutingModuleContent).toMatch(/import { AutoGeneratedComponent } from '.\/auto-generated\/auto-generated.component'/);
    ...
    describe('when the skipAutoGeneratedComponent flag is raised', () => {
        beforeEach(() => {
            const options = Object.assign({}, defaultOptions, { skipAutoGeneratedComponent: true });
        ...
        it('should not add a sample shared component', () => {
            ...
            expect(appComponentTemplate).toContain('<Label text="Entry Component works" textWrap="true"></Label>');
        });
    });
...
function setupProject(tree, schematicRunner, name) {
    tree = schematicRunner.runExternalSchematic('@schematics/angular', 'workspace', {
        name: 'workspace',
        version: '6.0.0',
        newProjectRoot: ''
    });
    tree = schematicRunner.runExternalSchematic('@schematics/angular', 'application', { name }, tree);
    return tree;
}
